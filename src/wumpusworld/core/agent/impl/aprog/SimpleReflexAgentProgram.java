package wumpusworld.core.agent.impl.aprog;

import java.util.Optional;
import java.util.Set;

import wumpusworld.core.agent.AgentProgram;
import wumpusworld.core.agent.impl.DynamicState;
import wumpusworld.core.agent.impl.ObjectWithDynamicAttributes;
import wumpusworld.core.agent.impl.aprog.simplerule.Rule;
