package wumpusworld.core.search.agent;

import java.util.Optional;
import java.util.function.BiFunction;
import java.util.function.Function;

import wumpusworld.core.agent.Agent;
import wumpusworld.core.agent.Notifier;
import wumpusworld.core.agent.impl.SimpleAgent;
import wumpusworld.core.search.nondeterministic.AndOrSearch;
import wumpusworld.core.search.nondeterministic.NondeterministicProblem;
import wumpusworld.core.search.nondeterministic.Plan;
